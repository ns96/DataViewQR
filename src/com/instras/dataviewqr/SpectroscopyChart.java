 ...
 * @author nathan
 */
public class SpectroscopyChart extends DataViewChart {
    
    private final String title = "Spectroscopy Data";
    
    public SpectroscopyChart() {
    ...
    private Component getXYChart(String[][] xydata) {
        ...
        double xmin = limits[0] - 10;
        double xmax = limits[1] + 10;
        double ymin = 0;
        double ymax = limits[3] + 0.05*limits[3];
