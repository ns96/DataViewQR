 ...
 */
package com.instras.dataviewqr.ssj.functions;
...
public PowerMathFunction (MathFunction func, double power) {
   ...
   public double derivative (double x) {
      ...
      return getA()*getPower()*MathUtil.pow (getA() * func.evaluate (x) + getB(), getPower() - 1)*fder;
   }

   public double evaluate (double x) {
      final double v = func.evaluate (x);
      return MathUtil.pow (a * v + b, power);
   }
}