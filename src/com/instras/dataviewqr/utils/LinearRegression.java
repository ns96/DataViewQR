...
public class LinearRegression {
   ...
   /**
     ...
     *
     * @param formatter This is used for formating numbers with the correct number of decimal places
     * @param  x the values of the predictor variable
     * @param  y the corresponding values of the response variable
     * @throws IllegalArgumentException if the lengths of the two arrays are not equal
     */
    public LinearRegression(L10NManager formatter, double[] x, double[] y) {
   ...
   /**
    ...
    public String toString() {
        String s = "";
        s += formatter.format(slope(), 2) + " N " +  formatter.format(intercept(), 2);
        return s + "  (R^2 = " + formatter.format(R2(), 3) + ")";
    }
}
